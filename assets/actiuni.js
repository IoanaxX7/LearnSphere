      ...
      fetch("actiuni/actiune.php", {
        ...
        .then((text) => {
          try {
            ...
            if (data.success) {
              // Update counts
              document.getElementById(`like-count-${materialID}`).innerText =
                data.likes;
              document.getElementById(`dislike-count-${materialID}`).innerText =
                data.dislikes;

              const likeBtn = document.querySelector(
                `.reaction-btn.like[data-id="${materialID}"]`
              );
              const dislikeBtn = document.querySelector(
                `.reaction-btn.dislike[data-id="${materialID}"]`
              );
