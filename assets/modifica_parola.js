window.addEventListener("DOMContentLoaded", (event) => {
  const parola1 = document.getElementById("modifica_parola1");
  const parola2 = document.getElementById("modifica_parola2");

  parola1.addEventListener("keyup", (event) => {
    const password = document.getElementById("modifica_parola1").value;
    const putere_parola = document.getElementById("putere_parola_modificata");
    const litere_mici = document.getElementById("litere_mici_parola_modificata");
    const litere_mari = document.getElementById("litere_mari_parola_modificata");
    const cifre = document.getElementById("cifre_parola_modificata");
    const caractere_speciale = document.getElementById("caractere_speciale_parola_modificata");
    const lungime_parola = document.getElementById("lungime_parola_modificata");
  ...
  document.querySelectorAll('input[type="password"]').forEach((item) => {
    item.addEventListener("keyup", (event) => {
      const valParola1 = document.getElementById("modifica_parola1").value;
      const valParola2 = document.getElementById("modifica_parola2").value;
      const potrivire_parole = document.getElementById("potrivire_parole_modificate");
